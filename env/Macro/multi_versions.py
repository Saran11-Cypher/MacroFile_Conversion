...
# Prompt once at the beginning
print("If multiple versions of a file are found, which one should be used?")
print("1. Oldest Version")
print("2. Latest Version")
...
result_message = f"✅ HRL files copied to '{HRL_PARENT_FOLDER}' and Excel file updated successfully!"
result_message
